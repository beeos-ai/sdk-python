...
class InstanceProjectionMetadata(BaseModel):
    """
    ...
    """ # noqa: E501
    accepted_epoch: Annotated[str, Field(strict=True)] = Field(alias="acceptedEpoch")
    accepted_revision: Annotated[str, Field(strict=True)] = Field(alias="acceptedRevision")
    canonical_hash: Annotated[str, Field(strict=True)] = Field(alias="canonicalHash")
    last_synced_at: datetime = Field(alias="lastSyncedAt")
    sync_state: StrictStr = Field(alias="syncState")
    agents_complete: StrictBool = Field(alias="agentsComplete")
    skills_complete: StrictBool = Field(alias="skillsComplete")
    __properties: ClassVar[List[str]] = ["acceptedEpoch", "acceptedRevision", "canonicalHash", "lastSyncedAt", "syncState", "agentsComplete", "skillsComplete"]

    @field_validator('accepted_epoch')
    def accepted_epoch_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^(0|[1-9][0-9]*)$", value):
            raise ValueError(r"must validate the regular expression /^(0|[1-9][0-9]*)$/")
        return value

    @field_validator('accepted_revision')
    def accepted_revision_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^(0|[1-9][0-9]*)$", value):
            raise ValueError(r"must validate the regular expression /^(0|[1-9][0-9]*)$/")
        return value
    ...
    def canonical_hash_validate_regular_expression(cls, value):
        """Validates the regular expression"""
    ...
    def sync_state_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['synced']):
            raise ValueError("must be one of enum values ('synced')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InstanceProjectionMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InstanceProjectionMetadata from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "acceptedEpoch": obj.get("acceptedEpoch"),
            "acceptedRevision": obj.get("acceptedRevision"),
            "canonicalHash": obj.get("canonicalHash"),
            "lastSyncedAt": obj.get("lastSyncedAt"),
            "syncState": obj.get("syncState"),
            "agentsComplete": obj.get("agentsComplete"),
            "skillsComplete": obj.get("skillsComplete")
        })
        return _obj
