...
class ServiceOperationsListResponse(BaseModel):
    """
    ServiceOperationsListResponse
    """ # noqa: E501
    operations: List[RuntimeOperationSnapshot]
    next_cursor: Optional[Annotated[str, Field(strict=True, max_length=128)]] = Field(default=None, alias="nextCursor")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["operations", "nextCursor"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServiceOperationsListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServiceOperationsListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "operations": [RuntimeOperationSnapshot.from_dict(_item) for _item in obj["operations"]] if obj.get("operations") is not None else None,
