...
class TaskWebhookResponseAllOfData(BaseModel):
    """
    ...
    task_id: StrictStr
    url: StrictStr
    has_secret: StrictBool = Field(description="`true` when an HMAC signing secret is configured for this webhook (P2-A). The raw secret is never returned — receivers verify against the secret they originally registered. ")
    created_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["webhook_id", "task_id", "url", "has_secret", "created_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TaskWebhookResponseAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TaskWebhookResponseAllOfData from a dict"""
        if obj is None:
            return None
