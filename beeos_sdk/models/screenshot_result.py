...
class ScreenshotResult(BaseModel):
    """
    A captured screenshot staged in BeeOS file storage. The image is referenced by `file_id` + a short-lived presigned `url`, never inline base64. 
    """ # noqa: E501
    file_id: StrictStr = Field(description="Stable BeeOS file id (resolvable via `GET /files/{id}`).")
    url: StrictStr = Field(description="Short-lived presigned download URL for the image.")
    format: Optional[StrictStr] = Field(default=None, description="Image codec (`png` / `jpeg`).")
    width: Optional[StrictInt] = None
    height: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["file_id", "url", "format", "width", "height"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScreenshotResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScreenshotResult from a dict"""
        if obj is None:
            return None
