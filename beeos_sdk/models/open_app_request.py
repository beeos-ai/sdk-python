...
class OpenAppRequest(BaseModel):
    ...
    OpenAppRequest
    """ # noqa: E501
    app: StrictStr = Field(description="Android package id or installed app display name.")
    activity: Optional[StrictStr] = None
    locale: Optional[StrictStr] = Field(default=None, description="Optional BCP-47 per-app locale (Android 13+, best effort).")
    __properties: ClassVar[List[str]] = ["app", "activity", "locale"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpenAppRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpenAppRequest from a dict"""
        if obj is None:
            return None
