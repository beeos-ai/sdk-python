...
class RuntimeOperationTargetOneOf2(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["scope", "platformAgentId", "conversationId"]

    @field_validator('scope')
    def scope_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['conversation']):
            raise ValueError("must be one of enum values ('conversation')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RuntimeOperationTargetOneOf2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RuntimeOperationTargetOneOf2 from a dict"""
        if obj is None:
            return None
