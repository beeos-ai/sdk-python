...
class RuntimeOperationTargetOneOf1(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["scope", "platformAgentId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RuntimeOperationTargetOneOf1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RuntimeOperationTargetOneOf1 from a dict"""
        if obj is None:
            return None
