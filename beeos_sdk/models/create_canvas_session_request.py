...
class CreateCanvasSessionRequest(BaseModel):
    ...
    """ # noqa: E501
    platform_agent_id: StrictStr = Field(alias="platformAgentId")
    conversation_id: StrictStr = Field(alias="conversationId")
    canvas_id: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=128)]] = Field(default=None, description="Opaque Canvas/A2UI surface identifier; not a UUID", alias="canvasId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["platformAgentId", "conversationId", "canvasId"]

    @field_validator('canvas_id')
    def canvas_id_validate_regular_expression(cls, value):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateCanvasSessionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateCanvasSessionRequest from a dict"""
        if obj is None:
            return None
