...
class PresignFileUpload200Response(BaseModel):
    """
    PresignFileUpload200Response
    """ # noqa: E501
    success: StrictBool
    data: Optional[PresignUploadResponse] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PresignFileUpload200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PresignFileUpload200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": PresignUploadResponse.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
