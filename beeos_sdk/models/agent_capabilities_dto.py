...
class AgentCapabilitiesDTO(BaseModel):
    ...
    """ # noqa: E501
    multiple_conversations: StrictBool = Field(alias="multipleConversations")
    load_conversation: StrictBool = Field(alias="loadConversation")
    create_conversation: StrictBool = Field(alias="createConversation")
    canvas: StrictBool
    terminal: StrictBool
    web_ssh: StrictBool = Field(alias="webSsh")
    file_system: StrictBool = Field(alias="fileSystem")
    image: StrictBool
    audio: StrictBool
    mcp: StrictBool
    cron: StrictBool
    streaming: StrictBool
    push_notifications: StrictBool = Field(alias="pushNotifications")
    a2a: StrictBool
    extended_agent_card: StrictBool = Field(alias="extendedAgentCard")
    models_list: StrictBool = Field(alias="modelsList")
    models_set: StrictBool = Field(alias="modelsSet")
    skills_list: StrictBool = Field(alias="skillsList")
    skills_install: StrictBool = Field(alias="skillsInstall")
    skills_uninstall: StrictBool = Field(alias="skillsUninstall")
    skills_update: StrictBool = Field(alias="skillsUpdate")
    __properties: ClassVar[List[str]] = ["multipleConversations", "loadConversation", "createConversation", "canvas", "terminal", "webSsh", "fileSystem", "image", "audio", "mcp", "cron", "streaming", "pushNotifications", "a2a", "extendedAgentCard", "modelsList", "modelsSet", "skillsList", "skillsInstall", "skillsUninstall", "skillsUpdate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AgentCapabilitiesDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AgentCapabilitiesDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "multipleConversations": obj.get("multipleConversations"),
            "loadConversation": obj.get("loadConversation"),
            "createConversation": obj.get("createConversation"),
            "canvas": obj.get("canvas"),
            "terminal": obj.get("terminal"),
            "webSsh": obj.get("webSsh"),
            ...
            "a2a": obj.get("a2a"),
            "extendedAgentCard": obj.get("extendedAgentCard"),
            "modelsList": obj.get("modelsList"),
            "modelsSet": obj.get("modelsSet"),
            "skillsList": obj.get("skillsList"),
            "skillsInstall": obj.get("skillsInstall"),
            "skillsUninstall": obj.get("skillsUninstall"),
            "skillsUpdate": obj.get("skillsUpdate")
        })
        return _obj
