...
class PartToolResult(BaseModel):
    """
    Tool-call output, paired with the originating tool_use via `tool_use_id`.
    """ # noqa: E501
    type: StrictStr
    tool_use_id: StrictStr
    content: PartToolResultContent
    is_error: Optional[StrictBool] = Field(default=None, description="True iff the tool call errored (model should treat as such).")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PartToolResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PartToolResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "content": PartToolResultContent.from_dict(obj["content"]) if obj.get("content") is not None else None,
