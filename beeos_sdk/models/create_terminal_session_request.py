...
class CreateTerminalSessionRequest(BaseModel):
    ...
    resume_terminal_id: Optional[StrictStr] = Field(default=None, alias="resumeTerminalId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["platformAgentId", "conversationId", "resumeTerminalId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateTerminalSessionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateTerminalSessionRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "resumeTerminalId": obj.get("resumeTerminalId")
        })
