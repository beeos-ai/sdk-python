...
class PressButtonRequest(BaseModel):
    ...
    PressButtonRequest
    """ # noqa: E501
    button: StrictStr = Field(description="Hardware / nav button name (`back` / `home` / `recent` / `power` / `volume_up` / `volume_down` / `enter`). ")
    __properties: ClassVar[List[str]] = ["button"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PressButtonRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PressButtonRequest from a dict"""
        if obj is None:
            return None
