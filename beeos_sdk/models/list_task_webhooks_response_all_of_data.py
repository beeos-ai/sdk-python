...
class ListTaskWebhooksResponseAllOfData(BaseModel):
    """
    ListTaskWebhooksResponseAllOfData
    """ # noqa: E501
    webhooks: List[ListTaskWebhooksResponseAllOfDataWebhooks]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListTaskWebhooksResponseAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListTaskWebhooksResponseAllOfData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "webhooks": [ListTaskWebhooksResponseAllOfDataWebhooks.from_dict(_item) for _item in obj["webhooks"]] if obj.get("webhooks") is not None else None
        })
        return _obj
