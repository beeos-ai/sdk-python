...
class AgentsApi:
    ...
    def list_agents(
        ...
        instance_id2: Annotated[Optional[Annotated[str, Field(strict=True, max_length=128)]], Field(description="CamelCase alias for `instance_id`.")] = None,
        status: Annotated[Optional[StrictStr], Field(description="Filter agents by runtime/directory status, for example `active`.")] = None,
        ...
        :param instance_id2: CamelCase alias for `instance_id`.
        :type instance_id2: str
        :param status: Filter agents by runtime/directory status, for example `active`.
        :type status: str
        :param limit:
        :type limit: int
        :param offset:
    ...
    def _list_agents_serialize(
        ...
        if instance_id2 is not None:
            
            _query_params.append(('instanceId', instance_id2))
