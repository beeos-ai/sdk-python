...
class RuntimeJSONRPCBusinessError(BaseModel):
    """
    RuntimeJSONRPCBusinessError
    """ # noqa: E501
    jsonrpc: Optional[Any]
    id: Optional[Any]
    error: RuntimeJSONRPCBusinessErrorError
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RuntimeJSONRPCBusinessError from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RuntimeJSONRPCBusinessError from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "error": RuntimeJSONRPCBusinessErrorError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
