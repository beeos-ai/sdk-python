...
class RuntimeOperationErrorContext(BaseModel):
    """
    RuntimeOperationErrorContext
    """ # noqa: E501
    active_runtime_epoch: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, alias="activeRuntimeEpoch")
    projection_revision: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, alias="projectionRevision")
    retry_after_ms: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, alias="retryAfterMs")
    expected_contract_revision: Optional[StrictStr] = Field(default=None, alias="expectedContractRevision")
    resource_id: Optional[StrictStr] = Field(default=None, alias="resourceId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["activeRuntimeEpoch", "projectionRevision", "retryAfterMs", "expectedContractRevision", "resourceId"]

    @field_validator('active_runtime_epoch')
    def active_runtime_epoch_validate_regular_expression(cls, value):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RuntimeOperationErrorContext from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RuntimeOperationErrorContext from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "activeRuntimeEpoch": obj.get("activeRuntimeEpoch"),
            "projectionRevision": obj.get("projectionRevision"),
            "retryAfterMs": obj.get("retryAfterMs"),
            "expectedContractRevision": obj.get("expectedContractRevision"),
