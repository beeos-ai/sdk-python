...
class PartToolUse(BaseModel):
    """
    Tool-call invocation issued by the agent.
    """ # noqa: E501
    type: StrictStr
    id: StrictStr = Field(description="Unique tool-call id; matches the `tool_use_id` on the corresponding tool_result.")
    name: StrictStr
    arguments: Optional[Any] = None
    state: Optional[PartState] = None
    __properties: ClassVar[List[str]] = ["type", "id", "name", "arguments", "state"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PartToolUse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PartToolUse from a dict"""
        if obj is None:
            return None
