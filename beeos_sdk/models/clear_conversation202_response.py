...
class ClearConversation202Response(BaseModel):
    """
    ...
    current_generation: Annotated[str, Field(strict=True)] = Field(alias="currentGeneration")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["status", "operationId", "conversationId", "currentGeneration"]
    ...
    def current_generation_validate_regular_expression(cls, value):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClearConversation202Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClearConversation202Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "currentGeneration": obj.get("currentGeneration")
        })
