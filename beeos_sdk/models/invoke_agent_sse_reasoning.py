...
class InvokeAgentSSEReasoning(BaseModel):
    """
    Agent reasoning (\"thinking\") chunk, delivered on a parallel stream independent of the answer `delta` frames. Concatenate `reasoning` text in order for the full chain-of-thought; it does NOT contribute to the final answer text. Optional to render. 
    """ # noqa: E501
    type: StrictStr
    text: StrictStr = Field(description="Streaming reasoning chunk text.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InvokeAgentSSEReasoning from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InvokeAgentSSEReasoning from a dict"""
        if obj is None:
            return None
