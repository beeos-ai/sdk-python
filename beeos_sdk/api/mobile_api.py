...
class MobileApi:
    ...
    def get_mobile_info(
        ...
        Returns the android instance's online status, screen geometry, supported actions, and foreground app. Returns 404 if the instance is a desktop device (use the `computer` endpoints). 
