...
class RuntimeOperationEventEnvelope(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "operationId", "method", "event"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RuntimeOperationEventEnvelope from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RuntimeOperationEventEnvelope from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "event": RuntimeOperationEventEnvelopeEvent.from_dict(obj["event"]) if obj.get("event") is not None else None
        })
