...
from beeos_sdk.api_response import ApiResponse, T as ApiResponseT
import beeos_sdk.models
from beeos_sdk import rest
from beeos_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(beeos_sdk.models, klass)
