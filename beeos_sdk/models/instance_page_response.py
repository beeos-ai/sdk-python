...
class InstancePageResponse(BaseModel):
    """
    InstancePageResponse
    """ # noqa: E501
    success: StrictBool
    data: List[InstanceDataDTO]
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["success", "data", "total"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InstancePageResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InstancePageResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": [InstanceDataDTO.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total")
        })
        return _obj
