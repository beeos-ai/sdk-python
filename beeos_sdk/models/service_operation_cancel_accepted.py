...
class ServiceOperationCancelAccepted(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["status", "operationId"]

    @field_validator('status')
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['cancel_requested']):
            raise ValueError("must be one of enum values ('cancel_requested')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServiceOperationCancelAccepted from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServiceOperationCancelAccepted from a dict"""
        if obj is None:
            return None
