...
class PatchMessageRequest(BaseModel):
    """
    Request body for `PATCH /api/v3/conversations/{cid}/messages/{mid}`. All fields are optional; the wire is SNAPSHOT-based — each PATCH carries the full cumulative body + parts the server should persist (NOT an indexed delta).  Returns `410 Gone` (`code = message_terminal`) if the row is already in a terminal state. 
    """ # noqa: E501
    body: Optional[StrictStr] = None
    parts: Optional[List[Part]] = None
    state: Optional[MessageState] = None
    stop_reason: Optional[StopReason] = None
    __properties: ClassVar[List[str]] = ["body", "parts", "state", "stop_reason"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchMessageRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchMessageRequest from a dict"""
        if obj is None:
            return None
