...
class ServiceOperationCursorConflict(BaseModel):
    """
    ServiceOperationCursorConflict
    """ # noqa: E501
    code: Optional[Any]
    operation_id: StrictStr = Field(alias="operationId")
    cursor: Annotated[str, Field(strict=True)]
    last_sequence: Annotated[str, Field(strict=True)] = Field(alias="lastSequence")
    http_status: Optional[Any] = Field(alias="httpStatus")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["code", "operationId", "cursor", "lastSequence", "httpStatus"]
    ...
    def last_sequence_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"^(0|[1-9][0-9]*)$", value):
            raise ValueError(r"must validate the regular expression /^(0|[1-9][0-9]*)$/")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServiceOperationCursorConflict from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.http_status is None and "http_status" in self.model_fields_set:
            _dict['httpStatus'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServiceOperationCursorConflict from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "lastSequence": obj.get("lastSequence"),
