...
class ClickRequest(BaseModel):
    ...
    x: StrictInt
    y: StrictInt
    button: Optional[StrictStr] = Field(default=None, description="Mouse button (`left` / `right` / `middle`). Default `left`.")
    count: Optional[StrictInt] = Field(default=None, description="Click count (1 = single, 2 = double). Default 1.")
    __properties: ClassVar[List[str]] = ["x", "y", "button", "count"]
