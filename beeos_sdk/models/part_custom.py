...
class PartCustom(BaseModel):
    """
    Extension escape hatch. New structured payloads (step markers, artifact refs, audio frames, code edits, …) can be carried under `custom.kind` without a schema migration. Old consumers SHOULD skip unrecognised kinds; new consumers route by `kind`. 
    """ # noqa: E501
    type: StrictStr
    kind: StrictStr = Field(description="Caller-controlled extension discriminant.")
    data: Optional[Any]
    __properties: ClassVar[List[str]] = ["type", "kind", "data"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PartCustom from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PartCustom from a dict"""
        if obj is None:
            return None
