...
RUNTIMEOPERATIONTARGET_ONE_OF_SCHEMAS = ["RuntimeOperationTargetOneOf", "RuntimeOperationTargetOneOf1", "RuntimeOperationTargetOneOf2"]

class RuntimeOperationTarget(BaseModel):
    """
    RuntimeOperationTarget
    """
    # data type: RuntimeOperationTargetOneOf
    oneof_schema_1_validator: Optional[RuntimeOperationTargetOneOf] = None
    # data type: RuntimeOperationTargetOneOf1
    oneof_schema_2_validator: Optional[RuntimeOperationTargetOneOf1] = None
    # data type: RuntimeOperationTargetOneOf2
    oneof_schema_3_validator: Optional[RuntimeOperationTargetOneOf2] = None
    actual_instance: Optional[Union[RuntimeOperationTargetOneOf, RuntimeOperationTargetOneOf1, RuntimeOperationTargetOneOf2]] = None
    one_of_schemas: Set[str] = { "RuntimeOperationTargetOneOf", "RuntimeOperationTargetOneOf1", "RuntimeOperationTargetOneOf2" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = RuntimeOperationTarget.model_construct()
        error_messages = []
        match = 0
        # validate data type: RuntimeOperationTargetOneOf
        if not isinstance(v, RuntimeOperationTargetOneOf):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RuntimeOperationTargetOneOf`")
        else:
            match += 1
        # validate data type: RuntimeOperationTargetOneOf1
        if not isinstance(v, RuntimeOperationTargetOneOf1):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RuntimeOperationTargetOneOf1`")
        else:
            match += 1
        # validate data type: RuntimeOperationTargetOneOf2
        if not isinstance(v, RuntimeOperationTargetOneOf2):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RuntimeOperationTargetOneOf2`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in RuntimeOperationTarget with oneOf schemas: RuntimeOperationTargetOneOf, RuntimeOperationTargetOneOf1, RuntimeOperationTargetOneOf2. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in RuntimeOperationTarget with oneOf schemas: RuntimeOperationTargetOneOf, RuntimeOperationTargetOneOf1, RuntimeOperationTargetOneOf2. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into RuntimeOperationTargetOneOf
        try:
            instance.actual_instance = RuntimeOperationTargetOneOf.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into RuntimeOperationTargetOneOf1
        try:
            instance.actual_instance = RuntimeOperationTargetOneOf1.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into RuntimeOperationTargetOneOf2
        try:
            instance.actual_instance = RuntimeOperationTargetOneOf2.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into RuntimeOperationTarget with oneOf schemas: RuntimeOperationTargetOneOf, RuntimeOperationTargetOneOf1, RuntimeOperationTargetOneOf2. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into RuntimeOperationTarget with oneOf schemas: RuntimeOperationTargetOneOf, RuntimeOperationTargetOneOf1, RuntimeOperationTargetOneOf2. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], RuntimeOperationTargetOneOf, RuntimeOperationTargetOneOf1, RuntimeOperationTargetOneOf2]]:
