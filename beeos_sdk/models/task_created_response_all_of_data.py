...
class TaskCreatedResponseAllOfData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["task_id", "agent_id", "status", "created_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TaskCreatedResponseAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TaskCreatedResponseAllOfData from a dict"""
        if obj is None:
            return None
