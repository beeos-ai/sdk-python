...
class DragRequest(BaseModel):
    ...
    x2: StrictInt
    y2: StrictInt
    duration_ms: Optional[StrictInt] = Field(default=None, description="Drag duration; clamped device-side to [1, 10000].")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DragRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DragRequest from a dict"""
        if obj is None:
            return None
