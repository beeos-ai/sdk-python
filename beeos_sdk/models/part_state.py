...
class PartState(str, Enum):
    """
    Per-part lifecycle. Only `thinking` and `tool_use` parts distinguish a streaming phase from a completed one; other part shapes ignore this field. 
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PartState from a JSON string"""
