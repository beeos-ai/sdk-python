...
class ConversationResponseAllOfData(BaseModel):
    """
    ...
    model_override_id: Optional[StrictStr] = Field(default=None, description="Session model override projected by Message Service after `PUT …/conversations/{id}/model` (session/set_model). Absent when the conversation uses the agent/instance default. ", alias="modelOverrideId")
    effective_model_id: Optional[StrictStr] = Field(default=None, description="Resolved effective model when Core/MS projects one alongside the override. Clients may fall back to modelOverrideId when this field is absent. ", alias="effectiveModelId")
    __properties: ClassVar[List[str]] = ["conversation_id", "agent_id", "title", "state", "metadata", "created_at", "last_activity_at", "closed_at", "modelOverrideId", "effectiveModelId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConversationResponseAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConversationResponseAllOfData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "modelOverrideId": obj.get("modelOverrideId"),
            "effectiveModelId": obj.get("effectiveModelId")
        })
        return _obj
