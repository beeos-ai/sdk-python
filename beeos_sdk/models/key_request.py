...
class KeyRequest(BaseModel):
    ...
    KeyRequest
    """ # noqa: E501
    keys: List[StrictStr] = Field(description="Key name(s). One key = a key press; multiple keys = a hotkey combo (desktop). Mobile callers pass a single Android KeyCode. ")
