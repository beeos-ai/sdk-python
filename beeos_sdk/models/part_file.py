...
class PartFile(BaseModel):
    """
    File attachment (image / audio / video / document). MIME type distinguishes modalities — the schema deliberately collapses image/audio/video into a single shape so adding new modalities is a renderer-side change rather than a schema migration. 
    """ # noqa: E501
    type: StrictStr
    url: StrictStr
    mime_type: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["type", "url", "mime_type", "name", "size"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PartFile from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PartFile from a dict"""
        if obj is None:
            return None
