...
class AttachmentRef(BaseModel):
    ...
    AttachmentRef
    """ # noqa: E501
    file_id: Annotated[str, Field(strict=True, max_length=128)] = Field(description="File identifier returned from [`POST /api/v1/files/presign-upload`](#operation/presignFileUpload). ")
    filename: Optional[StrictStr] = Field(default=None, description="Optional override for the file_record's filename.")
    content_type: Optional[StrictStr] = Field(default=None, description="Optional override for the file_record's MIME type.")
    __properties: ClassVar[List[str]] = ["file_id", "filename", "content_type"]
