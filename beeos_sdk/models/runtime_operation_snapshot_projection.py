...
class RuntimeOperationSnapshotProjection(BaseModel):
    """
    RuntimeOperationSnapshotProjection
    """ # noqa: E501
    revision: Annotated[str, Field(strict=True)]
    state: StrictStr
    platform_agent_id: Optional[StrictStr] = Field(default=None, alias="platformAgentId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["revision", "state", "platformAgentId"]
    ...
    def state_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['not_applicable', 'pending', 'synced', 'blocked']):
            raise ValueError("must be one of enum values ('not_applicable', 'pending', 'synced', 'blocked')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RuntimeOperationSnapshotProjection from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RuntimeOperationSnapshotProjection from a dict"""
        if obj is None:
            return None
