...
class CancelTaskRequest(BaseModel):
    ...
    CancelTaskRequest
    """ # noqa: E501
    reason: Optional[StrictStr] = Field(default=None, description="Free-form caller label propagated on the `chat_cancel` envelope payload so the agent can audit-log why its turn was aborted. Empty defaults to `canceled`. ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CancelTaskRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CancelTaskRequest from a dict"""
        if obj is None:
            return None
