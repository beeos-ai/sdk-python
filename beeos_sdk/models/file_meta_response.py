...
class FileMetaResponse(BaseModel):
    ...
    download_url: Optional[StrictStr] = Field(default=None, description="Presigned GET URL (24h default TTL on S3). Agents receive the same URL when the file is attached to an invoke / task envelope. ")
    __properties: ClassVar[List[str]] = ["file_id", "filename", "content_type", "size", "download_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FileMetaResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FileMetaResponse from a dict"""
        if obj is None:
            return None
