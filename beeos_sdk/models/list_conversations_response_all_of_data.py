...
class ListConversationsResponseAllOfData(BaseModel):
    """
    ListConversationsResponseAllOfData
    """ # noqa: E501
    conversations: List[ConversationResponseAllOfData]
    next_since: Optional[StrictStr] = Field(default=None, description="Pagination cursor. Empty when the caller has reached the end of results. ")
    __properties: ClassVar[List[str]] = ["conversations", "next_since"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListConversationsResponseAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListConversationsResponseAllOfData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "conversations": [ConversationResponseAllOfData.from_dict(_item) for _item in obj["conversations"]] if obj.get("conversations") is not None else None,
