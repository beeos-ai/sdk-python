...
class ProviderMeta(BaseModel):
    ...
    version: StrictStr
    __properties: ClassVar[List[str]] = ["id", "name", "description", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProviderMeta from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProviderMeta from a dict"""
        if obj is None:
            return None
