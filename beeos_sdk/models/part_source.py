...
class PartSource(BaseModel):
    """
    Citation / reference returned by retrieval-augmented agents.
    """ # noqa: E501
    type: StrictStr
    url: StrictStr
    title: Optional[StrictStr] = None
    snippet: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["type", "url", "title", "snippet"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PartSource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PartSource from a dict"""
        if obj is None:
            return None
