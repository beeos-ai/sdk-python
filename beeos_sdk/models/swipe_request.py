...
class SwipeRequest(BaseModel):
    ...
    x2: StrictInt
    y2: StrictInt
    duration_ms: Optional[StrictInt] = Field(default=None, description="Gesture duration; clamped device-side to [1, 10000].")
    __properties: ClassVar[List[str]] = ["x1", "y1", "x2", "y2", "duration_ms"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SwipeRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SwipeRequest from a dict"""
        if obj is None:
            return None
