...
class ListTasksResponseAllOfData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tasks", "next_since"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListTasksResponseAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListTasksResponseAllOfData from a dict"""
        if obj is None:
            return None
