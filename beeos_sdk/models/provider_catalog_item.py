...
class ProviderCatalogItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["meta", "capabilities"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProviderCatalogItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProviderCatalogItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "meta": ProviderMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "capabilities": ProviderCapabilities.from_dict(obj["capabilities"]) if obj.get("capabilities") is not None else None
        })
        return _obj
