...
class CancelConversationRequest(BaseModel):
    ...
    """ # noqa: E501
    target_message_id: Annotated[str, Field(min_length=1, strict=True, max_length=128)]
    reason: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["target_message_id", "reason"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CancelConversationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CancelConversationRequest from a dict"""
        if obj is None:
            return None
