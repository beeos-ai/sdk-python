...
class DeployRegionItem(BaseModel):
    """
    DeployRegionItem
    """ # noqa: E501
    id: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "available"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeployRegionItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeployRegionItem from a dict"""
        if obj is None:
            return None
