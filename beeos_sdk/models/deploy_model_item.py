...
class DeployModelItem(BaseModel):
    """
    DeployModelItem
    """ # noqa: E501
    id: StrictStr
    name: StrictStr
    tier: StrictStr
    reasoning: StrictBool
    __properties: ClassVar[List[str]] = ["id", "name", "tier", "reasoning"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeployModelItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeployModelItem from a dict"""
        if obj is None:
            return None
