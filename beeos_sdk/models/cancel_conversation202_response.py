...
class CancelConversation202Response(BaseModel):
    """
    CancelConversation202Response
    """ # noqa: E501
    success: StrictBool
    data: CancelConversation202ResponseData
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CancelConversation202Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CancelConversation202Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": CancelConversation202ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
