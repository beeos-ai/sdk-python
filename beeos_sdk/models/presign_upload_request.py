...
class PresignUploadRequest(BaseModel):
    ...
    """ # noqa: E501
    filename: Annotated[str, Field(strict=True, max_length=512)] = Field(description="Original filename hint; stored on the file record.")
    content_type: Annotated[str, Field(strict=True, max_length=255)] = Field(description="MIME type of the bytes being uploaded (e.g. `image/png`). Uploads with a different `Content-Type` may be rejected by the storage backend. ")
    __properties: ClassVar[List[str]] = ["filename", "content_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PresignUploadRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PresignUploadRequest from a dict"""
        if obj is None:
            return None
