...
class ListMessagesResponseAllOfData(BaseModel):
    """
    ListMessagesResponseAllOfData
    """ # noqa: E501
    messages: List[MessageDTO]
    latest_offset: StrictInt = Field(description="Channel's current max offset for \"caught up\" detection.")
    next_since: Optional[StrictStr] = Field(default=None, description="Public offset cursor to pass as the next request's since value.")
    has_more: StrictBool = Field(description="True when another page is available via next_since.")
    __properties: ClassVar[List[str]] = ["messages", "latest_offset", "next_since", "has_more"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListMessagesResponseAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListMessagesResponseAllOfData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "messages": [MessageDTO.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None,
            "latest_offset": obj.get("latest_offset"),
            "next_since": obj.get("next_since"),
