...
class ScrollRequest(BaseModel):
    ...
    direction: StrictStr = Field(description="Scroll direction (`up` / `down` / `left` / `right`).")
    amount: Optional[StrictInt] = Field(default=None, description="Distance multiplier (~300px per unit). Default 1.")
