...
class ContinueTaskRequest(BaseModel):
    ...
    auth_grant: Optional[StrictBool] = Field(default=None, description="Switches the wire envelope from `user.continue` to `user.auth_grant` — used to resume an `auth_required` pause (OAuth-style permission grant). ")
    __properties: ClassVar[List[str]] = ["input", "auth_grant"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ContinueTaskRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ContinueTaskRequest from a dict"""
        if obj is None:
            return None
