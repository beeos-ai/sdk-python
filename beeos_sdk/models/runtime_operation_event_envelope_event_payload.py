...
class RuntimeOperationEventEnvelopeEventPayload(BaseModel):
    """
    ...
    phase: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    current: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = None
    total: Optional[Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]]] = None
    committed_at: Optional[datetime] = Field(default=None, alias="committedAt")
    projection_revision: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, alias="projectionRevision")
    revision: Optional[Annotated[str, Field(strict=True)]] = None
    platform_agent_id: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, alias="platformAgentId")
    error_code: Optional[StrictStr] = Field(default=None, alias="errorCode")
    cause_code: Optional[StrictStr] = Field(default=None, alias="causeCode")
    requested_by: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, alias="requestedBy")
    reason: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["claimedAt", "executionMode", "phase", "current", "total", "committedAt", "projectionRevision", "revision", "platformAgentId", "errorCode", "causeCode", "requestedBy", "reason"]

    @field_validator('projection_revision')
    def projection_revision_validate_regular_expression(cls, value):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RuntimeOperationEventEnvelopeEventPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RuntimeOperationEventEnvelopeEventPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "projectionRevision": obj.get("projectionRevision"),
            "revision": obj.get("revision"),
            "platformAgentId": obj.get("platformAgentId"),
            "errorCode": obj.get("errorCode"),
            "causeCode": obj.get("causeCode"),
