...
class InvokeAgentResponseAllOfData(BaseModel):
    """
    InvokeAgentResponseAllOfData
    """ # noqa: E501
    text: StrictStr = Field(description="Agent reply text.")
    context_id: StrictStr = Field(description="Conversation context ID (channel ID).")
    is_error: StrictBool = Field(description="Whether the agent's reply indicated an error.")
    __properties: ClassVar[List[str]] = ["text", "context_id", "is_error"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InvokeAgentResponseAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InvokeAgentResponseAllOfData from a dict"""
        if obj is None:
            return None
