...
class ProviderCapabilities(BaseModel):
    ...
    """ # noqa: E501
    long_running: Optional[StrictBool] = Field(default=None, alias="longRunning")
    browser_use: Optional[StrictBool] = Field(default=None, alias="browserUse")
    code_exec: Optional[StrictBool] = Field(default=None, alias="codeExec")
    file_system: Optional[StrictBool] = Field(default=None, alias="fileSystem")
    custom_image: Optional[StrictBool] = Field(default=None, alias="customImage")
    max_duration_sec: Optional[StrictInt] = Field(default=None, alias="maxDurationSec")
    cost_model: Optional[StrictStr] = Field(default=None, alias="costModel")
    device: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["longRunning", "browserUse", "codeExec", "fileSystem", "customImage", "maxDurationSec", "costModel", "device"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "longRunning": obj.get("longRunning"),
            "browserUse": obj.get("browserUse"),
            "codeExec": obj.get("codeExec"),
            "fileSystem": obj.get("fileSystem"),
            "customImage": obj.get("customImage"),
            "maxDurationSec": obj.get("maxDurationSec"),
