...
class SetConversationModelRequest(BaseModel):
    ...
    """ # noqa: E501
    model_override_id: Annotated[str, Field(min_length=1, strict=True, max_length=128)] = Field(alias="modelOverrideId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["modelOverrideId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SetConversationModelRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SetConversationModelRequest from a dict"""
        if obj is None:
            return None
