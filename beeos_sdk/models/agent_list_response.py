...
class AgentListResponse(BaseModel):
    ...
    data: List[AgentDTO]
    total: StrictInt
    projection: Optional[InstanceProjectionMetadata] = None
    __properties: ClassVar[List[str]] = ["success", "data", "total", "projection"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [AgentDTO.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total"),
            "projection": InstanceProjectionMetadata.from_dict(obj["projection"]) if obj.get("projection") is not None else None
        })
        return _obj
